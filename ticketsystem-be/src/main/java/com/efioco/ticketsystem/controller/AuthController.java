...
public class AuthController {
	...
	// 🔑 LOGIN
	@PostMapping("/login")
	@Operation(summary = "Esegue il login e genera token JWT + refresh token.", description = """
	...
	@PostMapping("/refresh")
	@Operation(summary = "Rigenera un nuovo access token usando il refresh token salvato a DB.", description = """
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Nuovo access token generato correttamente"),
